    ...
    var DialogService = (function () {
        ...
        DialogService.prototype.show = function (viewModel, model, onCreated) {
            ...
            return this.compositionEngine.compose(instruction).then(function (controller) {
                ...
                var dialog = controller.view.bindingContext;
                if (onCreated)
                    onCreated(dialog);
                return _this.waitForClose(dialog, controller, dialogDiv, backdropDiv);
            });
        };
        DialogService.prototype.waitForClose = function (dialog, controller, dialogDiv, backdropDiv) {
...
define('bootstrap/login-dialog',["require", "exports", "aurelia-framework", "./dialog-base"], function (require, exports, aurelia_framework_1, dialog_base_1) {
    "use strict";
    var LoginDialog = (function (_super) {
        ...
        LoginDialog.prototype.activated = function (params) {
            this.message = params.message;
        };
        return LoginDialog;
    }(dialog_base_1.DialogBase));
    __decorate([
        aurelia_framework_1.bindable,
        __metadata("design:type", Object)
    ], LoginDialog.prototype, "message", void 0);
...
define('bootstrap/dialogs',["require", "exports", "aurelia-framework", "./dialog-service"], function (require, exports, aurelia_framework_1, dialog_service_1) {
    ...
    var Dialogs = (function () {
        ...
        Dialogs.prototype.showLogin = function (message) {
            return this.dialogService.show("bootstrap/login-dialog", { message: message });
        };
        return Dialogs;
    }());
    Dialogs = __decorate([
...
define('app',["require", "exports", "aurelia-framework", "./bootstrap/dialogs"], function (require, exports, aurelia_framework_1, dialogs_1) {
    ...
    var App = (function () {
        ...
        App.prototype.showDialog = function (getType) {
            alert(getType);
            if (getType == 'alert')
                this.dialogs.showAlert("Hello world!");
            if (getType == 'login')
                this.dialogs.showLogin("Hello Login!");
        };
        return App;
    }());
    App = __decorate([
...
define('text!app.html', ['module'], function(module) { module.exports = "<template>\n  <h1>${message}</h1>\n  <button click.trigger=\"showDialog('alert')\">Show dialog!</button>\n  <button click.trigger=\"showDialog('login')\">Show dialog!</button>\n</template>"; });
...
define('text!bootstrap/login-dialog.html', ['module'], function(module) { module.exports = "<template>\r\n    <require from=\"./dialog\"></require>\r\n\r\n    <bs-dialog title=\"Hello Login!\">\r\n        <div class=\"modal-body\">\r\n            ${message}\r\n        </div>\r\n        <div class=\"modal-footer\">\r\n            <button click.trigger=\"close()\">Close</button>\r\n        </div>\r\n    </bs-dialog>\r\n</template>"; });
